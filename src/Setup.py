    ...
    def setup(self, password: str):
        if platform == 'linux':
            ...
            if file_exists:
                ...
                action = click.prompt(
                    'Turbocharge found a pre-existing configuration. Would you like to reset it or install the contents of the config? [reset/install]: ')
                if action == 'install':
                ...
                click.echo(
                    f'Turbocharge couldn\'t find a pre-existing configuration, creating config.tcc at /home/{getuser()}.')
        ...
        if platform == 'darwin':
            ...
            if file_exists:
                ...
                # Config does not exist so creating config.tcc...
                click.echo(
                    f'Turbocharge couldn\'t find a pre-existing configuration, creating config.tcc at /Users/{getuser()}.')
